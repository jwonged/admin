...
<?php
	...
	{        
		...
		$query = "update questions set question = '$question', topic_id = '$topic', complexity = '$complexity', explanation ='$explane' where question_id = $questionid";
				
		if ($con->query($query) === TRUE) 	
		{
			$query1 = "update answer set answer = '$opt1' where ans_id = $optid1";
			$result1 = mysqli_query($con,$query1);
			
			$query2 = "update answer set answer = '$opt2' where ans_id = $optid2";
			$result2 = mysqli_query($con,$query2);
			
			$query3 = "update answer set answer = '$opt3' where ans_id = $optid3";
			$result3 = mysqli_query($con,$query3);
			
			$query4 = "update answer set answer = '$opt4' where ans_id = $optid4";
			$result4 = mysqli_query($con,$query4);
			
			$query5 = "select *from answer where answer = '$correct_option'  AND question_id = $questionid";
			...
			$query6 = "update questions set ans_id=$ansid where question_id = $questionid";
			
			if ($con->query($query6) === TRUE) 
			{ 
				/*header("Location:display_pquestion.php");*/
				echo "<script type='text/javascript'>location.href = 'display_pquestion.php';</script>";
			}
			else
			{
	...
	else
	{
		...
		$query10 = "select *from questions where question_id = $questionid";
		...
		$query12 = "select *from subject_details where sub_id = $subid";
...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			function back()
			{
				window.location.href="display_pquestion.php";
			}
						...
						<div class="control-group">
                         ...
                         <div class="message1"><?php if($message1!="") { echo $message1; } ?></div>
							...
							<?php 
								...
								$query11 = "select *from answer where question_id = $questionid";
								$result11 = mysqli_query($con,$query11);	
							...
							<div class="controls"> 
								<input type="text" name="Option1" id="Option1" onchange="load_drp();" value="<?php echo $option[0]; ?>" required>
							...
							<div class="controls">
								<input type="text" name="Option2" id="Option2" onchange="load_drp();" value="<?php echo $option[1]; ?>" required>
							...
							<div class="controls">
								<input type="text" name="Option3" id="Option3" onchange="load_drp();" value="<?php echo $option[2]; ?>" required>
							...
							<div class="controls" id="drp" name="drp">
								<select name="Coption" id="Coption" required> 
									...
									<?php 
										...
										$query12 = "select *from answer where question_id = $questionid";
										$result12 = mysqli_query($con,$query12);	
							...
							<div class="controls">
								...
								<textarea rows="4" cols="50" name="Explanation"><?php echo $row10['explanation'] ?></textarea>
							</div>
							<br>
						</div>
