...
<?php
	...
	{        
		...
		$query = "INSERT INTO test_questions VALUES('','$question','$subjectid','$topic','','$complexity','$explane','0','$date')";
		...
		if($question_id>0)	
		{
			...
			$query7 = "INSERT INTO test_question_details values('','$testid','$question_id')";
			
			if ($con->query($query7) === TRUE) 
			{  
				/*echo "<script type='text/javascript'>location.href ='edit_test.php?testid='".$testid."'&subjectid='".$subjectid."';</script>";*/
				echo "<script type='text/javascript'>location.href ='edit_school_test.php?testid=".$testid."&subjectid=".$subjectid."';</script>";
				
			}
			else
			{
				$message1= "Question are not added in test";
			}
		}
		else
		{
...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Add Test Questions | Online Exam </title>
		...
		<script type="text/javascript">
			...
			function back(testid,subid)
			{
				window.location.href="edit_school_test.php?testid="+testid+"&subjectid="+subid;
			}
						...
						<fieldset>
							...
							<div class="control-group">
							 ...
							 <div class="message1"><?php if($message1!="") { echo $message1; } ?></div>
								...
								<div class="controls">
									<textarea rows="4" cols="50" name="qtext" minlength="3" maxlength="500" required></textarea>
								</div>
								<br>
								<div class="control-label">
								...
								<div class="controls">
									<?php 
										...
										$query8 = "select * from subject_details where sub_id=".$subjectid;
										$result8 = mysqli_query($con,$query8);
										$row8 = mysqli_fetch_assoc($result8);
											
									?>	
									<input type="text" name="sub_name" id="sub_name" value="<?php echo $row8['sub_name'] ?>"disabled onchange="load_drp1();" required>
								</div>
								<br>
								<div class="control-label">
								...
								<div class="controls">
									<textarea rows="4" cols="50" name="Explanation"></textarea>
								</div>
								<br>
							</div>
							...
							<div class="control-group">
								...
								<input type="button" id="clear" value="Back" style="width: 77px;height: 30px;" class="btn btn-primary button-loading" data-loading-text="Loading..." onclick="back('<?php echo $testid ?>','<?php echo $subjectid ?>');">
								</div>
							</div>
						</fieldset>
					</form>
