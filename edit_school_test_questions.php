	...
	<head>
		...
		<script type="text/javascript">
			...
			function back(test_id,subid)
			{
				...
				window.location.href="edit_school_test.php?testid="+test_id+"&subjectid="+subid;
			}
					...
					<fieldset>
						...
						<div class="control-group">
                         ...
                         <div class="message1"><?php if($message1!="") { echo $message1; } ?></div>
							...
							<div class="controls"> 
								<input type="text" name="Option1" id="Option1" value="<?php echo $option[0]; ?>" required>
							...
							<div class="controls">
								<input type="text" name="Option2" id="Option2" value="<?php echo $option[1]; ?>" required>
							...
							<div class="controls">
								<input type="text" name="Option3" id="Option3" value="<?php echo $option[2]; ?>" required>
