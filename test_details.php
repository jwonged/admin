...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Test Details | Online Exam </title>
		...
		<script type="text/javascript">
			function myFunction(testid) 
			{
				...
				{
				   window.location = "delete_test.php?testid="+testid;
				}
			}
		</script>
					...
					<div class="span6" id="form-login">
						...
						<form name="menuitemgroupoption_form" enctype="multipart/form-data" style="background-color:#f5f5f5;width: 1060px;margin-left: -228px;border-radius: 4px;">
							<table id="table1" name="table1" border='1' width=90% style="margin:30px;">
								<br>
								<tr>
									<legend style="text-align:center;color:#29AAE1 ; font-weight:bolder;">Test Details</legend>
									<br>
										<div class="control-label" style="width: 287px;margin-left:30%;">
							...
							<div class="controls" id="que" name="que" style="margin-left:376px;">
								<input type="button" id="clear" name="clear" value="Add Test" style="width: 220px;height: 40px;" class="btn btn-primary button-loading" data-loading-text="Loading..." onclick="add_tests();">
							</div>	
							</table>	
							...
							<table id="table2" class="table_legenda" name="table2" border='1' width=90% style="margin:30px;">
								...
								<?php
									...
									$query2 = "select * from tests_details where sub_id=$first_value order by test_id desc";
										...
										echo "<tr>";
											...
											if($row3['created_by']==0)
											{
												...
												echo "<td style='height:30px;'><center>Admin</center></td>";
													echo "<td align='center' style=';height: 30px;'> <a href='edit_test.php?testid=".$row3['test_id']."&subjectid=".$first_value."' class='button edit'>Edit</a>
