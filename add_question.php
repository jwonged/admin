...
<?php
	...
	{        
		...
		$query = "INSERT INTO questions VALUES('','$question','$subjectid','$topic','','$complexity','$explane','$date')";
		$result = mysqli_query($con,$query);
		$question_id = mysqli_insert_id($con);
					
		if($question_id!=0)	
		{
			$query1 = "INSERT INTO answer (answer, question_id) VALUES ('$opt1','$question_id')";
			$result1 = mysqli_query($con,$query1);
			
			$query2 = "INSERT INTO answer (answer, question_id) VALUES ('$opt2','$question_id')";
			$result2 = mysqli_query($con,$query2);
			
			$query3 = "INSERT INTO answer (answer, question_id) VALUES ('$opt3','$question_id')";
			$result3 = mysqli_query($con,$query3);
			
			$query4 = "INSERT INTO answer (answer, question_id) VALUES ('$opt4','$question_id')";
			$result4 = mysqli_query($con,$query4);
			
			$query5 = "select *from answer where answer = '$correct_option'  AND question_id = $question_id";
			$result5 = $con->query($query5);
			
			/*$query7 = "INSERT INTO practice_question (topic_id, question_id) VALUES ('$topic','$question_id')";
			$result7 = mysqli_query($con,$query7);*/
			
			$row5 = mysqli_fetch_array($result5);
			$ansid = $row5['ans_id'];
		
			$query6 = "update questions set ans_id=$ansid where question_id = $question_id";
...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Add Practice Questions | Online Exam </title>
			...
			<div class="row">
				...
				<div class="span6" id="form-login">
					<form class="form-horizontal well" action="" method="post" name="add_question" enctype="multipart/form-data" >
						...
						<fieldset>
							<legend style="text-align:center;color:#29AAE1 ; font-weight:bolder;">Add Practice Question</legend>
