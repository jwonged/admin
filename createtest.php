...
<?php
	...
	else
	{
		...
		{        
			...
			$query1 = "select *from tests_details where BINARY name='$testnm'";
			...
			{
				$query = "INSERT INTO tests_details VALUES('','$testnm','$subjectid','0','','$date')";
				...
				{
					$message1= "Test can't add successfully";
				}
			}			
		}
		else
...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Add Test | Online Exam </title>
		...
		<script type="text/javascript">
			...
			function add_questions()
			{
				...
				window.location.href="add_test_question.php?testnm="+test_name+"&sub="+subject;
			}
		...
		<script type="text/javascript">
			...
			{	
				...
				{
				   window.location = "delete_createtest_question.php?questionid="+questionid;
				}
			}
		</script>
										...
										if(isset($_SESSION['q_id']))
										{
											...
											for($i=0;$i<count($question_ids);$i++)
											{
												...
												while($row1 = mysqli_fetch_assoc($result1))
												{
													...
													echo "<td align='center' style='width: 330px;height: 30px;'><a href='edit_createtest_question.php?queid=".$row1['question_id']."&subjectid=".$_SESSION['subjectid']."' class='button edit'>Edit</a>&nbsp;<a href='#' class='button delete' onclick='myFunction(".$row1['question_id'].");'>Delete</a></td>";
													echo "</tr>";
												}
											}	
										}	
