...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>School Login | Objective Exam </title>
	...
	<body onload="myFunction();">    
		...
		<?php
			...
			if(count($_POST)>0) 
			{
				...
				$result10 = $con->query("SELECT * FROM school_details WHERE BINARY userName='" . $_POST["userName"] . "' and BINARY password = '". $_POST["pass"]."'");
				$row10  = mysqli_fetch_array($result10);
						
				if(is_array($row10)) 
				{
					$_SESSION["user_id"] = $row10['school_id'];
					$_SESSION["user_name"] = $user;
							
					echo "<script type='text/javascript'>location.href = 'school_homepage.php';</script>";
							/*header("Location:school_homepage.php");*/
				}
				else 
				{
		...
		<div class="row">
			...
			<div class="span6" id="form-login">
				<form class="form-horizontal well" action="" method="post" name="login_form" enctype="multipart/form-data" style="background-color:#34495E;">
					...
					<fieldset>
						<legend style="text-align:center;color:#fff; font-weight:bolder;">School Login</legend>
