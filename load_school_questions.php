	<?php
		...
		$schoolid = $_GET['school_id'];
			...
			$query2 = "SELECT * FROM test_questions WHERE subject_id=$sub_id AND (created_by=$schoolid or created_by=0)";	
	...
	<select name="question[]" id="question" multiple="multiple" required class="multiselect">
